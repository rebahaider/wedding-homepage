    ...
    return (
        <div className="bg-[#FFF7F8] ">
            <div className="relative min-h-screen md:h-[1000px] bg-no-repeat bg-cover" style={{ backgroundImage: `url(${festive})` }}>
                <div className="absolute -bottom-24 mx-10 md:left-32 md:w-[1100px] md:h-[200px] border-2 border-white rounded-3xl bg-gradient-to-t from-[#FFF3F1] to-[#FFFFFF] space-y-6 pt-10 pl-14">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-32 mx-20">
                <div className="border-2 border-white rounded-3xl bg-gradient-to-t from-[#FFF3F1] to-[#FFFFFF] space-y-4 py-7 px-8">
                    <img src={target} alt="" />
